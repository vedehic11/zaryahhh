                  ...
                  selectedProducts.map((item) => (
                    <div key={item.product.id} className="flex items-center space-x-3 p-3 bg-cream-50 rounded-lg border border-cream-200">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-charcoal-900 text-sm">{item.product.name}</h4>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-charcoal-900 w-8 text-center">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.product.id, item.quantity + 1)}
                          className="w-6 h-6 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center hover:bg-primary-200 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="w-6 h-6 bg-error-100 text-error-600 rounded-full flex items-center justify-center hover:bg-error-200 transition-colors"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </div>
              ...
              {selectedProducts.length > 0 && (
                <div className="border-t border-primary-200 pt-4 mb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-primary-700">₹{getTotalPrice().toLocaleString()}</span>
                  </div>
                </div>
              )}
